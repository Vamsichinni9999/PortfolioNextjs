  ...
  return (
    <div className="w-full bg-transparent text-gray-200 shadow-lg p-4">
      <div className="flex flex-col items-center justify-center m-auto">
        <div className="w-full flex flex-row items-start justify-around flex-wrap">
          ...
          <div className="min-w-[200px] flex flex-col items-center text-center mb-4">
            ...
            <Link
              ...
              className="flex items-center my-2 cursor-pointer"
            >
              <span className="text-[15px]">Aws Certified Cloud Pratitioner</span>
            </Link>
            <Link
              href="https://www.netacad.com/courses/programming/pcap-programming-essentials-python"
              target="_blank"
          ...
          <div className="min-w-[200px] flex flex-col items-center text-center mb-4">
            ...
            <Link
              href="https://www.linkedin.com/in/chinni-yadav-8215ab230/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center my-2 cursor-pointer"
            >
            ...
            <Link
              href="https://github.com/chinni9999"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center my-2 cursor-pointer"
            >
            ...
            <Link
              href="https://www.instagram.com/chinni9999"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center my-2 cursor-pointer"
            >
        ...
        <div className="mt-8 text-[15px] text-center cursor-pointer">
          Contact: <Link href="mailto:vamsichinni2004@gmail.com">vamsichinni2004@gmail.com</Link>
        </div>
      </div>
    </div>
  );
